...
mod tests {
    ...
    fn checks_dynamic_rule_segments_without_blocking_unrelated_siblings() {
        let rules = || vec![rule("dir", "<home>/Profiles/*/Saves", "ludusavi", None)];

        let possible_parent = check(
            "linux",
            "/home/player",
            "/home/player/Profiles/Profile",
            rules(),
            vec![],
        );
        let unrelated_sibling = check(
            "linux",
            "/home/player",
            "/home/player/Profiles/Profile/Config",
            rules(),
            vec![],
        );
        let mapped_child = check(
            "linux",
            "/home/player",
            "/home/player/Profiles/Profile/Saves/Slot",
            rules(),
            vec![],
        );
