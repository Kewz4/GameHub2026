...
export const CATALOGUE_PLATFORM_SELECT_ID = "catalogue-platform-select";
export const CATALOGUE_CONSOLE_SELECT_ID = "catalogue-console-select";
export const CATALOGUE_PROTON_SELECT_ID = "catalogue-proton-select";
export const CATALOGUE_DECK_SELECT_ID = "catalogue-deck-select";
