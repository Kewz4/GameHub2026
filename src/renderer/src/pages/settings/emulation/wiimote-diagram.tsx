  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="3.45"
        rx="0.45"
        fill={on("up") ? DIAGRAM.accent : "transparent"}
      />
      <rect
        {...hit("down")}
        x="10.65"
        ...
        height="3.45"
        rx="0.45"
        fill={on("down") ? DIAGRAM.accent : "transparent"}
      />
      <rect
        {...hit("left")}
        x="6.6"
        ...
        height="3.32"
        rx="0.45"
        fill={on("left") ? DIAGRAM.accent : "transparent"}
      />
      <rect
        {...hit("right")}
        x="14.58"
        ...
        height="3.32"
        rx="0.45"
        fill={on("right") ? DIAGRAM.accent : "transparent"}
      />
      ...
      <g {...hit("b")}>
        <rect
          ...
          rx="1.676"
          ry="1.676"
          fill={on("b") ? DIAGRAM.accent : DIAGRAM.btn}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".5"
        />
      ...
      <path
        fill={on("b") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("l1")}>
        <rect
          ...
          fill={on("l1") ? DIAGRAM.accent : DIAGRAM.btn}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".485"
        />
      ...
      <path
        fill={on("l1") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("l2")}>
        <rect
          ...
          fill={on("l2") ? DIAGRAM.accent : DIAGRAM.btn}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".485"
        />
      ...
      <path
        fill={on("l2") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("a")}>
        <circle
          ...
          cy="31.458"
          r="3.871"
          fill={on("a") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".5"
        />
      ...
      <path
        fill={on("a") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("select")}>
        <circle
          ...
          cy="47.922"
          r="2.177"
          fill={on("select") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".281"
        />
      ...
      <path
        fill={on("select") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
        d="M6.246,47.857v.3h-1.142v-.3h1.142Z"
      />
      ...
      <g {...hit("r3")}>
        <circle
          ...
          cy="47.922"
          r="2.177"
          fill={on("r3") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".281"
        />
      ...
      <path
        fill={on("r3") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("start")}>
        <circle
          ...
          cy="47.922"
          r="2.177"
          fill={on("start") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".281"
        />
      ...
      <path
        fill={on("start") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("x")}>
        <circle
          ...
          cy="73.853"
          r="2.262"
          fill={on("x") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".292"
        />
      ...
      <path
        fill={on("x") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
      ...
      <g {...hit("y")}>
        <circle
          ...
          cy="82.665"
          r="2.262"
          fill={on("y") ? DIAGRAM.accent : DIAGRAM.btnRaised}
          stroke={DIAGRAM.line}
          strokeMiterlimit="10"
          strokeWidth=".292"
        />
      ...
      <path
        fill={on("y") ? DIAGRAM.accentText : DIAGRAM.btnLabel}
