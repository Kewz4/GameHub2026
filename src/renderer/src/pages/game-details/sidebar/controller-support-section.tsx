...
import "./controller-support-section.scss";
...
export function ControllerSupportSection() {
  ...
  const controllerSupport = useMemo(() => {
    ...
    const details = shopDetails as unknown as ControllerSupportDetails;
          ...
          <>
            {status !== "none" && (
              <div className="controller-support__icons" aria-hidden="true">
                <Gamepad2 size={20} className="controller-support__icon" />
              </div>
            )}
